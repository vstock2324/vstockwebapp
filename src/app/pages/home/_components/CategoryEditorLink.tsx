...
const CategoryEditorLink=async()=> {
  ...
  return (
      ...
      <div className="cursor-pointer flex flex-col items-center justify-between space-y-[10px] md:space-y-[30px] relative">
        <img className="w-[250px] h-[142px] object-fill  bg-cover bg-[#D9D9D9]  bg-no-repeat rounded-[15px] border border-solid opacity-15 border-[#FFF]"
...
export default memo(CategoryEditorLink);