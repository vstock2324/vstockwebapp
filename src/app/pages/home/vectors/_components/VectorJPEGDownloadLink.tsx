...
const VectorJPEGDownloadLink = () => {
  ...
  return (
    <>
      <button
        className={`bg-[#0BAC6F]  ${loading ? "cursor-progress":"cursor-pointer"} flex flex-row items-center justify-center w-[30%] p-1 rounded-full text-lg font-normal text-white`}
