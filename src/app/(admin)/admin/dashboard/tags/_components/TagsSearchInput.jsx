...
import useAdminTags from "@/context/useAdminTags";


const TagsSearchInput = () => {
  const supabase = createClient();
  const {getTags,setTags}=useAdminTags();
  ...
  return (
    <>
      <div className="relative mx-auto my-4 w-full inline-flex flex-row items-center justify-center">
        <input
          type="text"
          placeholder={"Search Tag Name"}
          onChange={handleSearch}
          className="rounded-[77px]  bg-[#DDDDDD]  text-white text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] flex-shrink-0  w-full h-12 py-[16px] px-[29px]  outline-none focus:outline-none placeholder:font-poppins400   font-poppins400  font-extralight placeholder:font-extralight  placeholder:text-white not-italic"
        />
...
export default memo(TagsSearchInput);
