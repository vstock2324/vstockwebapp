    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Home", route: "/" },{label:"Users",route:"/admin/dashboard/users"},
        ],
      },
      {
        icon: (
      ...
      // },
      {
        ...
        route: "#",
        children: [
          { label: "Images", route: "/admin/dashboard/uploads/images" },
          { label: "Videos", route: "/admin/dashboard/uploads/videos" },
        ],
      },
      {
